...
function disableCards() {
    ...
    flippedCards += 2;
    console.log("Flipped " + flippedCards + " cards.");

    if (flippedCards === cards.length) {
        console.log("All cards flipped! Congratulations!");
        const canvas = document.getElementById("c");
        if (canvas) {
            canvas.classList.remove('hidden-canvas');
        }
        flippedCards = 0; //should be placed into restart function;
        //do something stylish, provide restart button;
    }
